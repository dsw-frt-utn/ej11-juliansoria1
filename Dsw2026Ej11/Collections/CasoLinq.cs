...
public class CasoLinq
{
    ...
    // 6. Obtener lista de string (Título y Precio en moneda)
    ...
    {
        decimal promedioGeneral = libros.Average(l => l.Precio);
        return libros.Where(l => l.Precio > promedioGeneral).ToList();
    }
